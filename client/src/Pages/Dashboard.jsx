        ...
        {allResumes.map((resume, index) => {
          ...
          return (
            <button
              ...
              style={{
                background: `linear-gradient(0deg,${baseColor}10, ${baseColor}40)`,
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-4 border border-slate-300 rounded focus:border-green-600 focus:outline-none"
              required
            />
